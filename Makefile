...
# @Font: https://nono.ma/makefile-read-and-get-environment-variable-from-file
include ./environments/$(ENVIRONMENT).env
export $(shell sed 's/=.*//' ./environments/$(ENVIRONMENT).env)
